...
module CryptoVenues.Venues.BinanceFut where
...
apiUrl :: BaseUrl
apiUrl = BaseUrl Https "fapi.binance.com" 443 "/fapi/v1"

-- | https://fapi.binance.com/fapi/v1/exchangeInfo
type ApiMarkets
   =  "exchangeInfo"
   :> Get '[JSON] (MarketList "binance-fut")

instance EnumMarkets "binance-fut" where
   allMarkets = DataSrc apiUrl clientM
      where
         clientM = SC.client (Proxy :: Proxy ApiMarkets)

instance Json.FromJSON (MarketList "binance-fut") where
   parseJSON val =
...
instance MarketBook "binance-fut" where
...
instance Json.FromJSON (RateLimit "binance-fut") where
   parseJSON val =
...
instance Json.FromJSON (SomeBook "binance-fut") where
   parseJSON val =
...
type ApiRateLimit
   =  "exchangeInfo"
   :> Get '[JSON] (RateLimit "binance-fut")
...
perSecond :: BRateLimit -> RateLimit "binance-fut"
